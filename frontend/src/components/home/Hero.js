...
import heroImg from "assets/Onboarding22.png";
const Hero = () => {
  return (
    <>
        ...
        <div className="m-auto overflow-hidden mx-4 mt-8 lg:mt-4 p-2 md:p-12 h-5/6">
          ...
          >
            <div className="lg:w-1/2 flex flex-col justify-center">
              <h1 className="mb-5 md:text-5xl text-3xl font-bold text-gray-800">
                Onboarding in Three Clicks!
              </h1>
              <div className="text-xl font-semibold tracking-tight mb-5 text-gray-600">
                Effortlessly manage and track your new hire onboarding process.
              </div>
              <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
                <Link
                  to="/login"
                  className="text-black bg-blue-400 hover:bg-blue-300 inline-flex items-center justify-center w-full px-6 py-3 my-4 text-lg shadow-xl rounded-2xl sm:w-auto sm:mb-0"
                >
                  Get Started
                  <svg
